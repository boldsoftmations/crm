...
export const PendingFollowup = () => {
  ...
  const PendingFollowUps = async (e) => {
    try {
      e.preventDefault();
      setOpen(true);
      ...
      const data = {
        id: pendingData[0].id,
        leads: pendingData[0].leads,
        current_date: pendingData[0].current_date,
        next_followup_date: pendingData[0].next_followup_date,
        notes: pendingData[0].notes,
