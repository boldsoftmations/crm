...
export const TodayFollowup = () => {
  ...
  const TodayFollowUps = async (e) => {
    try {
      e.preventDefault();
      setOpen(true);
      const data = {
        id: todayData[0].id,
        leads: todayData[0].leads,
        current_date: todayData[0].current_date,
        next_followup_date: todayData[0].next_followup_date,
        notes: todayData[0].notes,
        user: todayData[0].user,
        is_followed_up: true,
      };
